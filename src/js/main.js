...
view.ui.add(searchWidget, "bottom-right");
  ...
  $("#category").change(function(){
    ...
    if (catValue == 1){
      ...
      $("#unemployField-select").css("visibility", "hidden");
      ...
      $("#unemployField-select").css("visibility", "visible");
  ...
  function countyRenderer(field, classField){
    ...
    var text = legendText(field);

    //Parameters for the class breaks renderer
    var params = {
      layer: county,
      field: field,
      basemap: map.basemap,
  ...
  function legendText(field){
    var text;
    //Create a readable description for the legend
    if (field == "Pop_White"){
